...
<section class="content">
    ...
    <div class="card-body">
        ...
        <a href="<?= base_url('kategori/add')?>" class="btn btn-success btn-sm">
        ...
        <table class="table table-bordered table-hover text-center" id="barang">
            ...
            <tbody>
                <?php $no=1; $total=0; foreach($kategori->result() as $data):?>
                <tr>
                    <td><?= $no++;?></td>
                    <td><?= $data->nama_kategori;?></td>
                    <td>
                        <a href="<?= base_url('kategori/ubah/'.$data->id_kategori)?>" class="btn btn-primary btn-sm">
                            <i class="fa fa-pencil-alt"></i>
                        </a>    |
                        <form action="<?= base_url('kategori/del')?>" method="post" class="d-inline">
