            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control <?= form_error('harga_barang') ? 'is-invalid' : null?>" id="harga_barang" name="harga_barang" placeholder="Masukan Harga Barang" value="<?= $this->input->post('harga_barang')?>">
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <select name="kategori_barang" id="kategori_barang" class="form-control <?= form_error('kategori_barang') ? 'is-invalid' : null ?>">
                            ...
                            <?php foreach($kategori->result() as $ktg):?>
                                <option value="<?= $ktg->id_kategori?>" <?= set_value('kategori_barang') == $ktg->id_kategori ? 'selected' : null ?>><?= $ktg->nama_kategori?></option>
                            <?php endforeach;?>
                        </select>
                    </div>
